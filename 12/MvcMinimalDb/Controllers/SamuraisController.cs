...
namespace MvcMinimalDb.Controllers
{
    public class SamuraisController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,BattleId")] Samurai samurai)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,BattleId")] Samurai samurai)
        {
            if (id != samurai.Id)
            {
                return NotFound();
